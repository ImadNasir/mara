    ...
    body: Stack(
      children: [
        Container(
          ...
          child: Image.asset(widget.imageli,
        ...
        Container(
          margin: EdgeInsets.only(top: 290.h,bottom: 26.h,left: 26.w,right: 26.w),
          width: double.infinity,
          decoration: BoxDecoration(
              ...
              Container(
                ...
                child: ListTile(
                  leading: InkWell(
                    ...
                    child: CircleAvatar(
                      radius: 24.sp,
                      backgroundColor: _value? Color(0xFF2D2AF6): Colors.black26,
                      child:  Icon(
                        Icons.check,
                        size: 30.sp,
                        color: Colors.white,
