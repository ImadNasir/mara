            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  width: double.infinity,
                  height: 217.h,
                  decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.circular(30.h)),
                  child: Stack(children:[
                  Image.asset('Assets/Images/s2.png', fit: BoxFit.fill,width: 367.w,),
                  Align(
                    alignment: Alignment.center,
                    child: Icon(Icons.play_circle_outline_outlined,size: 70.sp, color: Colors.white,),
                  )
                  ]
                ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(color: Color(0xFF2D2AF6),
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Materials_build(quantitiy: '1x',item: 'Tigeras',),
                            Materials_build(quantitiy: '2x',item: 'Rollos de papel',),
                            Materials_build(quantitiy: '1x',item: 'Pintura Acrílica',),
                            Materials_build(quantitiy: '1x',item: 'Pincel',),
                            Materials_build(quantitiy: '1x',item: 'Rollo de cartón A4',),
                          ],
                        ),
                      )
                    ],
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                style: TextStyle(fontSize: 15.sp, wordSpacing: 3.sp ,),
